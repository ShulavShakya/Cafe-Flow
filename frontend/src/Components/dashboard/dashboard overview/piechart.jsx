...
function Piechart() {
  ...
  const { menuPopularity } = useOrders();
  const colorMap = {
    Food: '#F59E0B',
    Dessert: '#FACC15',
    'Hot Beverage': '#EAB676',
  ...
  const hasData = menuPopularity && menuPopularity.length > 0;
  ...
  return(
      <div className="bg-white rounded-2xl shadow-md p-4">
          <div className="flex items-start justify-between mb-1 gap-1">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-[#0F172A] text-[11px]">Soft Drinks</span>
              </div>

              <div className="flex items-center gap-1">
                <div className="w-3 h-3 rounded-sm bg-[#C2410C]"></div>
                <span className="text-[#0F172A] text-[11px]">Hard Drinks</span>
              </div>
          ...
          (
            <div className="h-75 w-full flex items-center justify-center text-gray-400">
